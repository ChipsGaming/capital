module.exports = class{
   ...
   *
   * @param {Discord.Message} message Целевое сообщение.
   */
  reply(message){
   ...
   *
   * @param {Discord.Client} client Получатель сообщения.
   */
  send(client){
   ...
   *
   * @param {Array[Discord.Client]} clients Получатели сообщения.
   */
  sendAll(clients){
